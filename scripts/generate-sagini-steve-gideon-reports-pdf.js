...
async function generateSaginiSteveGideonReportsPDF() {
  ...
  try {
    console.log('📊 Generating Reports for Sagini, Steve, and Gideon\n');
    
    // Users to generate reports for
    const usersToReport = [
      { name: 'Sagini', searchPattern: '%Sagini%' },
      { name: 'Steve', searchPattern: '%Steve%' },
      { name: 'Gideon', searchPattern: '%Gideon%' }
    ];
...
generateSaginiSteveGideonReportsPDF();
