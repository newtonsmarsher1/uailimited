...
async function generateMembaFaithReportsPDF() {
  ...
  try {
    console.log('📊 Generating Reports for Brian Memba kebaso and Faith Isaiah\n');
    
    // Users to generate reports for
    const usersToReport = [
      { name: 'Brian Memba kebaso', searchPattern: '%Brian%Memba%' },
      { name: 'Faith Isaiah', searchPattern: '%Faith%Isaiah%' }
    ];
