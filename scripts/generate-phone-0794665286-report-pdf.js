...
async function generatePhone0794665286ReportPDF() {
  ...
  try {
    console.log('📊 Generating Report for Phone Number: 0794665286\n');
    ...
    const [user] = await pool.query(`
      ...
      FROM users 
      WHERE phone = '0794665286'
    `);
    
    if (user.length === 0) {
      console.log('❌ User with phone number 0794665286 not found');
      return;
    }
...
generatePhone0794665286ReportPDF();
