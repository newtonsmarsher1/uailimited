...
async function generateConceptaLamechKevinReportsPDF() {
  ...
  try {
    console.log('📊 Generating Reports for Concepta Okenye, Lamech Sunda, and Kevin Onyongo\n');
    
    // Users to generate reports for
    const usersToReport = [
      { name: 'Concepta Okenye', searchPattern: '%Concepta%Okenye%' },
      { name: 'Lamech Sunda', searchPattern: '%Lamech%Sunda%' },
      { name: 'Kevin Onyongo', searchPattern: '%Kevin%Onyongo%' }
    ];
...
generateConceptaLamechKevinReportsPDF();
