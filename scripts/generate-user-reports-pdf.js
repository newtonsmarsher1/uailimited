...
async function generateUserReportsPDF() {
  ...
  try {
    console.log('📊 Generating User Reports in PDF Format\n');
    
    // Users to generate reports for
    const usersToReport = [
      { id: 202, name: 'Michael Nyandiri Bikundu', phone: '+254111394208' },
      { id: 163, name: 'GEORGE MORARA MIKONGU', phone: '0796744053' }
    ];
