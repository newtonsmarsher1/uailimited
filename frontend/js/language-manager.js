    ...
    this.translations = {
      'en': {
        ...
        'casino-btn-label': 'Click here to enter the casino',
         ...
         'today-earning-label': 'Today\'s Earnings',
         'month-earning-label': 'This Month',
         'total-revenue-label': 'Total Revenue',
         'total-withdrawal-label': 'Total Withdrawn',
         'task-history-title': 'Recent Task History',
         'total-tasks-label': 'Total Tasks',
         'active-days-label': 'Active Days',
         'longest-streak-label': 'Longest Streak',
         'avg-reward-label': 'Avg Reward',
         'prev-page': 'Previous',
         'next-page': 'Next',
        ...
        // Login page
        'login-title': 'UAI Login',
        'welcome-login-msg': 'Welcome to UAI! Please log in to continue.',
        'login-btn': 'Log in',
        
        // Signup page
        'signup-title': 'UAI Register',
        ...
        'from-level': 'from Level',
                 ...
                 // Recharge page
         'recharge-title': 'Enhanced Recharge Method',
         // Withdrawal page
      ...
      'sw': {
        ...
        'casino-btn-label': 'Bofya hapa kuingia kwenye kasino',
         ...
         'today-earning-label': 'Mapato ya Leo',
         'month-earning-label': 'Mwezi Huu',
         'total-revenue-label': 'Jumla ya Mapato',
         'total-withdrawal-label': 'Jumla ya Uondoaji',
         'task-history-title': 'Historia ya Kazi za Hivi Karibuni',
         'total-tasks-label': 'Jumla ya Kazi',
         'active-days-label': 'Siku za Kufanya Kazi',
         'longest-streak-label': 'Mfululizo Mrefu',
         'avg-reward-label': 'Tuzo ya Wastani',
         'prev-page': 'Iliyotangulia',
         'next-page': 'Ifuatayo',
        ...
        // Login page
        'login-title': 'UAI Ingia',
        'welcome-login-msg': 'Karibu kwenye UAI! Tafadhali ingia kuendelea.',
        'login-btn': 'Ingia',
        
        // Signup page
        'signup-title': 'UAI Jisajili',
        ...
        'from-level': 'kutoka Kiwango',
                 ...
                 // Recharge page
         'recharge-title': 'Njia ya Kuchaji ya Juu',
         // Withdrawal page
         'withdrawal-title': 'Toa Fedha',
        'error': 'Hitilafu',
        'success': 'Mafanikio',
      ...
      'fr': {
        ...
        'casino-btn-label': 'Cliquez ici pour entrer au casino',
         ...
         'today-earning-label': 'Gains d\'aujourd\'hui',
         'month-earning-label': 'Ce mois',
         'total-revenue-label': 'Revenus totaux',
         'total-withdrawal-label': 'Retraits totaux',
         'task-history-title': 'Historique récent des tâches',
         'total-tasks-label': 'Total des tâches',
         'active-days-label': 'Jours actifs',
         'longest-streak-label': 'Plus longue série',
         'avg-reward-label': 'Récompense moyenne',
         'prev-page': 'Précédent',
         'next-page': 'Suivant',
        ...
        // Login page
        'login-title': 'UAI Connexion',
        'welcome-login-msg': 'Bienvenue à UAI! Veuillez vous connecter pour continuer.',
        'login-btn': 'Se connecter',
        
        // Signup page
        'signup-title': 'UAI S\'inscrire',
        ...
        'from-level': 'du niveau',
                 ...
                 // Recharge page
         'recharge-title': 'Méthode de recharge améliorée',
         // Withdrawal page
         'withdrawal-title': 'Retirer des fonds',
        'error': 'Erreur',
        'success': 'Succès',
